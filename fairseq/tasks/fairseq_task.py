...
class FairseqTask(object):
    ...
    def build_dictionary(
        cls, filenames, workers=1, threshold=-1, nwords=-1, padding_factor=8, fileformat='smiles'
    ):
        ...
        """
        d = Dictionary()
        if fileformat == "smiles":
            t = tokenizer.tokenize_smiles
        else:
            t = tokenizer.tokenize_line
        for filename in filenames:
            Dictionary.add_file_to_dictionary(
                filename, d, t, workers
            )
